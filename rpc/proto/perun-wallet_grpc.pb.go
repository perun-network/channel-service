...
func (c *channelServiceClient) RestoreChannels(ctx context.Context, in *RestoreChannelsRequest, opts ...grpc.CallOption) (*RestoreChannelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/perunservice.ChannelService/RestoreChannels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *channelServiceClient) NewPerunClient(ctx context.Context, in *NewPerunClientRequest, opts ...grpc.CallOption) (*NewPerunClientResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/perunservice.ChannelService/NewPerunClient", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChannelService_RestoreChannels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/perunservice.ChannelService/RestoreChannels",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChannelService_NewPerunClient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/perunservice.ChannelService/NewPerunClient",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
